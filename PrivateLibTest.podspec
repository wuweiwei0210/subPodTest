...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PrivateLibTest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/846591806@qq.com/PrivateLibTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '846591806@qq.com' => '846591806@qq.com' }
  s.source           = { :git => 'https://github.com/846591806@qq.com/PrivateLibTest.git', :tag => s.version.to_s }
